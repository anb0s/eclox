...
//			if(event.getProperty() == eclox.core.preferences.Names.BUILD_HISTORY_SIZE) {
...
//	}
	...
	public void load() {
		...
		String[]	rawPaths;
		savedHistoryContent = Plugin.getDefault().getPluginPreferences().getString( eclox.core.preferences.Names.BUILD_HISTORY_CONTENT );
	...
	public void log(IFile file) {
		...
		int size = Plugin.getDefault().getPluginPreferences().getInt(eclox.core.preferences.Names.BUILD_HISTORY_SIZE);
...
//	}
	...
	public void store() {
		...
		Plugin.getDefault().getPluginPreferences().setValue(
			eclox.core.preferences.Names.BUILD_HISTORY_CONTENT,
			savedFilePaths );
	}
