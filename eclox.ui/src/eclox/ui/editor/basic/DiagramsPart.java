...
public class DiagramsPart extends Part {
     ...
     */
    private MultiEditor diagrams = new RadioMultiEditor(
            new String[] { DIAGRAM_NONE, DIAGRAM_BUILT_IN, DIAGRAM_DOT_TOOL });
    ...
    DiagramsPart(Composite parent, FormToolkit toolkit, Doxyfile doxyfile) {
        ...
        // Setup all editors.
        if (doxyfile.hasSetting("CLASS_DIAGRAMS") && doxyfile.hasSetting("HAVE_DOT")) {
